...
void test_bsearch(const VecT& test, T target, BsearchPolicy policy = BsearchPolicy::UNSPECIFIED)  {
    auto it = bsearch(test.begin(), test.end(), target, policy);     //    end() isn't the last element -- it's one beyond the last element
